<template>
  <div class="aside" v-if="data">
    ...
    <el-row type="flex" justify="space-between" class="info-bar" v-if="data.seat_infos">
      <span>成人机票</span>
    ...
    <div v-if="InsuranceList.indexOf(1)>-1">
      <el-row type="flex" justify="space-between" class="info-bar">
        <span>航空意外险</span>
        <span>¥30/人/单程</span>
        <span>x1</span>
    ...
    <div v-if="InsuranceList.indexOf(2)>-1">
      <el-row type="flex" justify="space-between" class="info-bar">
        <span>航空延误险</span>
        <span>¥30/人/单程</span>
        <span>x1</span>
